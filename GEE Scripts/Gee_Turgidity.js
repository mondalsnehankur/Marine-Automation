// ============================================================
// TURBIDITY EXTRACTION
// SUNDARBANS ESTUARINE SYSTEM
// USING MODIS Kd490 PROXY
// 2020 - 2024
// ============================================================
...
// ------------------------------------------------------------
// LOAD MODIS OCEAN DATASET
// ------------------------------------------------------------

var oceanCollection = ee.ImageCollection(
...
for (var year = 2020; year <= 2024; year++) {
  ...
  for (var month = 1; month <= 12; month++) {
    ...
    // --------------------------------------------------------
    // CREATE TURBIDITY IMAGE
    // --------------------------------------------------------

    var turbidityImage = ee.Image(
    ...
    var sampled = turbidityImage.sampleRegions({
      collection: stations,
      scale: 4000,
      geometries: false
    });
...
print('Turbidity Dataset', finalCollection);
...
Export.table.toDrive({
  ...
  description: 'Sundarbans_Turbidity_2020_2024',
  folder: 'GEE_Marine_Project',
  fileNamePrefix: 'sundarbans_turbidity',
  fileFormat: 'CSV'
});

print('Turbidity extraction completed successfully.');